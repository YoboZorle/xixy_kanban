...
class XixyKaban extends StatefulWidget {
  final double tileHeight = 100;
  final double headerHeight = 80;
  final double tileWidth = 300;

  @override
  _XixyKabanState createState() => _XixyKabanState();
}

class _XixyKabanState extends State<XixyKaban> {
  ...
  @override
  Widget build(BuildContext context) {
    buildXixyKabanList(String listId, List<Item> items) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(title: Text("Xixy Kaban")),
      body: SingleChildScrollView(
        ...
        child: Row(
            ...
            children: board.keys.map((String key) {
              return Container(
                width: widget.tileWidth,
                child: buildXixyKabanList(key, board[key]),
              );
            }).toList()),
      ),
    );
